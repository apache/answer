...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/answer/api/v1/personal-access-tokens": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/schema.PersonalAccessTokenInfo"
                                            }
                                        }
                                    }
                                }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/schema.PersonalAccessTokenCreateReq"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/schema.PersonalAccessTokenCreateResp"
                                        }
                                    }
                                }
                            ]
        ...
        "/answer/api/v1/personal-access-tokens/current": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/schema.PersonalAccessTokenCurrentResp"
                                        }
                                    }
                                }
                            ]
        ...
        "/answer/api/v1/user/reauthenticate": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/schema.UserReauthenticateReq"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "schema.PersonalAccessTokenCreateReq": {
            "type": "object",
            "required": [
                "expires_at",
                "name",
        ...
        "schema.PersonalAccessTokenCreateResp": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "integer"
        ...
        "schema.PersonalAccessTokenCurrentResp": {
            "type": "object",
            "properties": {
                "token": {
                    "$ref": "#/definitions/schema.PersonalAccessTokenInfo"
                ...
                "user": {
                    "$ref": "#/definitions/schema.PersonalAccessTokenUserInfo"
                }
            }
        },
        "schema.PersonalAccessTokenInfo": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "integer"
        ...
        "schema.PersonalAccessTokenUserInfo": {
            "type": "object",
            "properties": {
                "display_name": {
                    "type": "string"
