...
const (
	...
	PersonalAccessTokenInsufficientScope        = "error.personal_access_token.insufficient_scope"
	PersonalAccessTokenReauthenticationRequired = "error.personal_access_token.reauthentication_required"
)
